...
// 过滤需要加入缓存的api
const addApiCache = [
  /https?:\/\/www.xploers.net\//,
  /http?:\/\/47.254.84.222:8888\//,
  /http?:\/\/47.106.253.251:8888\//,
]
// 需要缓存的请求
...
self.addEventListener('appinstalled',  (evt) => {console.log('a2hs installed')})
